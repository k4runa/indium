...
namespace Indium
{
    ...
    void TilemapComponent::inspect(std::function<void()> snapshotCb)
    {
        ...
        if (loaded_)
        {
            ...
            ImGui::Image((ImTextureID)(uintptr_t)tileset_.id, ImVec2(previewW, previewH), ImVec2(0,1), ImVec2(1,0));
            ImGui::SameLine();
            ImGui::BeginGroup();
        ...
        ImGui::TextDisabled("Tile Palette  (click to select)");
        {
            ...
            ImGui::Image((ImTextureID)(uintptr_t)tileset_.id, ImVec2(palW, palH), ImVec2(0,1), ImVec2(1,0));
            ...
            if (ImGui::IsItemHovered() && ImGui::IsMouseClicked(0))
            {
                ...
                if (pc >= 0 && pc < tsColCount && pr >= 0 && pr < tsRowCount) selectedTile_ = pr * tsColCount + pc;
            }
